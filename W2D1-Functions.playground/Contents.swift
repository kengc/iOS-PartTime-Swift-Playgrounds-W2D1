...
func pluralize(count: Int) {
    if count > 1 {
        print("There are \(count) bicycles")
    } else if count < 1 {
        print("There are \(count) bicycles")
    } else {
        print("There is \(count) bicycle")
    }
}
...
func pluralizedString(count: Int) -> String {
    var msg = "";
    if count > 1 {
        msg = "There are \(count) bicycles"
    } else if count < 1 {
        msg = "There are \(count) bicycles"
    } else {
        msg = "There is \(count) bicycle"
    }
    return msg
}
...
//print(pluralizedString(count: 1))
//
//print(pluralizedString(count: 0))
//
//print(pluralizedString(count: 100))
...
func pluralizedWord(singular: String, pluralNoun: String, count: Int ) -> String
{
    var msg = "";
    if (count > 1 || count == 0) {
        msg = "There are \(count) \(pluralNoun)"
    } else if count == 1 {
        msg = "There is \(count) \(singular)"
    }
    return msg
 }
...
print(pluralizedWord(singular: "octopus", pluralNoun: "octopi", count: 1))
print(pluralizedWord(singular: "woman", pluralNoun: "women", count: 2))
print(pluralizedWord(singular: "apple", pluralNoun: "apples", count: 0))
